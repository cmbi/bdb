...
def check_ccp4():
    ...
    Strategy:
        ...
        program exists) before an OSError (raised if the program cannot be
        called), after our attempt to call the program with an invalid argument.
    """
...
def check_deps():
    """Test if dependencies have been set up properply.
